...
/**
 * @ORM\Entity(repositoryClass="Avl\UserBundle\Entity\FaqCategorysRepository")
 * @ORM\Table(name="faq_categorys")
 * @UniqueEntity("path")
 * @UniqueEntity("name")
...
class FaqCategorys
{
     ...
     * @ORM\JoinColumn(name="faq", referencedColumnName="id", nullable=true, onDelete="SET NULL")
     * @Assert\Valid
     */
    protected $faq;
