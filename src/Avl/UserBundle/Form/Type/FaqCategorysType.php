...
class FaqCategorysType extends AbstractType
{
    /**
     * @var
     */
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder
            ->add('name', 'text', array(
                'label' => 'label.faq.categorys.name',
                'required' => true
            ))
            ->add('path', 'text', array(
                'label' => 'label.path',
            ...
            ->add('enabled', 'checkbox', array(
                'label' => 'label.faq.categorys.enabled',
                'required' => false
            ))
            ->add('internal', 'checkbox', array(
                'label' => 'label.faq.categorys.internal',
                'required' => false
            ))
        ;
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'Avl\UserBundle\Entity\FaqCategorys'
        ));
    }
